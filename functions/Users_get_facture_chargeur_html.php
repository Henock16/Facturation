...
include_once('../functions/Get_SQLChargeurs_function.php');//ajouter pour test
...
include_once('../functions/Complete_function.php');
   ...
   function getFactureChargeurHtml($char,$debut,$fin,$type,$pont,$numfac){
...
/////////////////////////////////
   $res = GetSQLChargeurs($debut,$fin,$char,$pont,$type);
   ...
   $account=getvalue($bdf,'IDENTIFIANT,NOM','CHARGEUR','IDENTIFIANT',$char);
   $chrg=($account[0]?getvalue($bdf,'NOM,NUM_CC','CHARGEUR','IDENTIFIANT',$account[0]):getvalue($bds,'NOM,NUM_CC','CHARGEUR','IDENTIFIANT',$account[0]));
   $bp='&nbsp;';
    $tel='&nbsp;';
    $ncc='&nbsp;';
    $acompte='0';
 ...
 $html='<img width="300px" height="60px" src="../images/cci.jpg" alt="profile"/> 
          ...
          <table width="100%">
                <tr>
                   ...
                   <tr>
                      <td style="'.$titre.'font-size: 30px;" width="50%">'.$chrg[0].'</td>
                   </tr>
                   <tr>
                      <td width="40%">&nbsp;</td>
                  </tr>
                   ...
                   <tr>
                      <td width="40%">
                      <p style="'.$titre1.' white-space: nowrap;">'.((empty($ncc))?'':'NCC: ').$ncc.'</p>
                      </td>
                  </tr>
             </table>';
